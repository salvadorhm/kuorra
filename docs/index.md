...
Esta herramienta esta compuesta por 2 partes:
    ...
    Kuorra Model basado en la arquitectura de 3 capas MVC (Model-View-Controller).

    Kuorra CLI una herramienta de línea de comandos que permite generar la estructura completa de un proyecto nuevo.
